        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="bg-white py-8 px-4 shadow-xl shadow-indigo-100 sm:rounded-xl sm:px-10 border border-gray-100">
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              {/* Input Password dengan Toggle Mata & Lupa Password */}
              <div className="space-y-2">
                ...
                {/* Teks button Lupa Password */}
                <div className="flex justify-end pr-1 mt-1">
                  <Link href="/forgot-password" className="text-xs text-[#263C92] hover:underline font-medium transition-colors">
                    Lupa Password?
                  </Link>
                </div>
              </div>
              ...
              <Button 
                type="submit"
                disabled={isLoading}
                className="w-full h-12 bg-[#263C92] hover:bg-[#1d2d6e] text-white font-bold rounded-lg flex items-center justify-center gap-2 group transition-all mt-4"
              >
